...
export function CabinScene({ canMove, guests, hasKnock, onLookThroughDoor, onPlayerPositionChange, playerPosition, room }: CabinSceneProps) {
  ...
  return (
    <section className={`cabin cabin--${room}`} aria-label={`Cabin ${room}`}>
      ...
      <div className="cabin-world" style={{ '--camera': camera, '--player-x': playerPosition, '--player-depth': depth } as CSSProperties}>
        ...
        <div className="cabin-room"><LivingRoomScene guests={guests} hasKnock={hasKnock} onLookThroughDoor={onLookThroughDoor} /></div>
